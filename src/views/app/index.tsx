  ...
  const activityTimeline = [
    {
      ...
      description: 'Chevron Nigeria Limited submitted a new application for drilling equipment',
      time: '2 hours ago',
      type: 'info',
      icon: FileText
    },
    ...
    },
    {
      ...
      description: 'APP-2023-004 has been rejected due to insufficient documentation',
      time: '1 day ago',
      type: 'error',
      icon: AlertCircle
    },
    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Welcome back! Here's what's happening with your applications today.</p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>Latest applications submitted to the NCDMB portal</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <TableBody>
                      {recentApplications.map((app) => (
                        <TableRow key={app.id}>
                          ...
                          <TableCell className="max-w-[200px] truncate">{app.applicant}</TableCell>
          ...
          <Card>
            ...
            <CardContent className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">Applications management functionality coming soon</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">Detailed activity log coming soon</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
