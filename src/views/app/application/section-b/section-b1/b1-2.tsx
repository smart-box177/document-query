...
const SectionB12 = () => {
    ...
    const [records, setRecords] = useState<PersonnelRecord[]>(
        formData.sectionB?.b1?.b1_2 ? [formData.sectionB.b1.b1_2] : []
    )
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                        Other Personnel (Construction, Installation, Security, Fabrication, Commissioning, Corporate Services, etc)
                    </p>
                </div>
